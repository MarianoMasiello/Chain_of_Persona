...
OUT_AGGRESSIVE = "./data_instruct_consensus_aggressive1/"
OUT_SANDWICHED = "./data_instruct_consensus_sandwiched1/"
...
def main():
    ...
    # SCRIPT A ORDER: Aggressive -> Sandwiched
    print("\n🚀 STARTING PHASE 1: AGGRESSIVE PROMPTS")
    ...
    print("\n🚀 STARTING PHASE 2: SANDWICHED PROMPTS")
