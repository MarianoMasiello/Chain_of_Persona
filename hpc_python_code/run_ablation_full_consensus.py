...
INPUT_CSV = "./data/intersectional_consensus_sentences_whicon_blalib.csv" # Ensure this matches your uploaded filename
...
def main():
    ...
    for temp in TEMPERATURES:
        ...
        results = []
        output_file = f"./data/llama3_consensus_ablation_T{temp}_N{VOTES_PER_SENTENCE}.csv"
