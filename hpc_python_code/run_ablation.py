...
INPUT_CSV = "./data/intersectional_test_sentences_whicon_blalib.csv" # Ensure this matches your uploaded filename
...
def main():
    ...
    for temp in TEMPERATURES:
        ...
        results = []
        output_file = f"./data/llama3_ablation_T{temp}_N{VOTES_PER_SENTENCE}.csv"
